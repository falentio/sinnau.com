...
<div class="grid min-h-svh bg-background lg:grid-cols-2">
	...
	<div class="relative hidden overflow-hidden bg-muted lg:block">
		<div
			class="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,var(--primary),transparent_28rem),linear-gradient(135deg,var(--background),var(--muted))] opacity-70"
		></div>
		<div class="absolute inset-0 flex items-center justify-center p-12">
			<div class="max-w-md space-y-4 text-center">
				...
				<h2 class="text-3xl font-semibold tracking-tight">Turn notes into practice</h2>
				<p class="text-muted-foreground">
					Create study sets, generate flashcards, and keep each practice session focused.
				</p>
			</div>
		</div>
	</div>
