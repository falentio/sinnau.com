...
>
  ...
  <Form.Field {form} name="files">
    ...
    <Form.Description
      >Unggah materi dalam format PDF atau DOCX.</Form.Description
    >
    <Form.FieldErrors />
  </Form.Field>
  ...
  {#if advancedMode}
    <Form.Field {form} name="instructions">
      ...
      <Form.Description
        >Opsional. Berikan instruksi spesifik untuk menghasilkan konten yang
        diinginkan.</Form.Description
      >
      <Form.FieldErrors />
    </Form.Field>
  {/if}
