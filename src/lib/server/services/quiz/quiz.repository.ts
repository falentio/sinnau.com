...
export interface QuizRepository {
	...
	updateQuiz(id: string, ownerId: string, patch: QuizUpdatePatch): Promise<Quiz | null>;
	...
	findOptionsByIdsForOwner(ids: string[], ownerId: string): Promise<QuizOption[]>;
	findOptionByIdForOwner(id: string, ownerId: string): Promise<QuizOption | null>;
