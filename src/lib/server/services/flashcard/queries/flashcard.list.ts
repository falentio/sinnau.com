...
import { flashcardListOutputSchema, getFlashcardsInputSchema } from '$lib/schemas/flashcard';
...
export const flashcardList = authorizedProcedure
	...
	.handler(async ({ input, context }) => flashcardService.getFlashcards(input, context.user.id));
