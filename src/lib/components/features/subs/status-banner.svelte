<script lang="ts">
  ...
  const meta = {
    CANCELLED: {
      ...
      body: "Pesanan ini tidak dilanjutkan. Tidak ada paket yang aktif.",
      icon: Cancel01Icon,
    ...
    EXPIRED: {
      ...
      body: "Pesanan ini sudah kedaluwarsa. Buat pesanan baru dari halaman paket.",
      icon: Alert02Icon,
    ...
    PAID: {
      ...
      body: "Paket kamu aktif. Kuota generate sudah ditambahkan.",
      icon: Tick02Icon,
